...
export default function BackendTopicCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const backendTopic = (
            await client.graphql({
              query: createBackendTopic.replaceAll("__typename", ""),
              variables: {
                input: {
                  ...modelFieldsToSave,
                },
      ...
      {...getOverrideProps(overrides, "BackendTopicCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
