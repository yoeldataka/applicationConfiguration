...
import { createApplicationStageCognitoUserPool } from "../graphql/mutations";
const client = generateClient();
export default function ApplicationStageCognitoUserPoolCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setUserPoolId(initialValues.userPoolId);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createApplicationStageCognitoUserPool.replaceAll(
              "__typename",
              ""
            ),
            variables: {
      ...
      {...getOverrideProps(
        overrides,
        "ApplicationStageCognitoUserPoolCreateForm"
      )}
      {...rest}
    >
      <TextField
