...
import { createAiTaskTypes } from "../graphql/mutations";
const client = generateClient();
export default function AiTaskTypesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAiTaskTypes.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AiTaskTypesCreateForm")}
      {...rest}
    >
      <TextField
        label="Types"
