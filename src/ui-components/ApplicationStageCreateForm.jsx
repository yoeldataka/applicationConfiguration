...
import { createApplicationStage } from "../graphql/mutations";
...
export default function ApplicationStageCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            aiSettingsID: modelFields?.aiSettings?.id,
            backendSettingsID: modelFields?.backendSettings?.id,
            frontendSettingsID: modelFields?.frontendSettings?.id,
            cognitoUserPoolID: modelFields?.cognitoUserPool?.id,
          };
          await client.graphql({
            query: createApplicationStage.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFieldsToSave,
              },
      ...
      {...getOverrideProps(overrides, "ApplicationStageCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
