...
export default function ApplicationCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setDEV(initialValues.DEV);
    setCurrentDEVValue(undefined);
    setCurrentDEVDisplayValue("");
    setSTAGING(initialValues.STAGING);
    ...
    setAiServerSnapshotReference(initialValues.aiServerSnapshotReference);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            devStageID: modelFields?.DEV?.id,
            stagingStageID: modelFields?.STAGING?.id,
            prodStageID: modelFields?.PROD?.id,
            aiServerSnapshotReferenceID:
              modelFields?.aiServerSnapshotReference?.id,
          };
          await client.graphql({
